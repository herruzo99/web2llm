...
# This helps us ignore common clutter and binary files.
GITHUB_SCRAPER_IGNORE_CONFIG = {
    ...
    "extensions": [
        ...
        ".dll", ".exe", ".class", ".jar", ".deb", ".rpm",
        # Media files
        ".png", ".jpg", ".jpeg", ".gif", ".webp", ".svg", ".mp4", ".mp3", ".mov", ".wav", ".ico",
    ]
}

# Configuration for the generic web scraper.
WEB_SCRAPER_CONFIG = {
    # A list of CSS selectors, ordered by priority, to find the main content of a page.
    ...
    # CSS selectors to find navigation elements, which we can use to extract site structure.
    "nav_selectors": [
