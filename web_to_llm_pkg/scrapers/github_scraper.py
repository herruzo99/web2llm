...
def _process_directory(
    ...
    for path in start_paths:
        for dirpath, dirnames, filenames in os.walk(path, topdown=True):
            ...
            dirnames[:] = [d for d in dirnames if d not in CODE_IGNORE_CONFIG["directories"] and d not in exclude_dirs]
            ...
            for f in sorted(filenames):
                ...
                if f.lower() in ignore_files_lower or extension in CODE_IGNORE_CONFIG["extensions"]:
                    continue
...
class GitHubScraper(BaseScraper):
    ...
    def __init__(self, url: str, include_dirs: str, exclude_dirs: str):
