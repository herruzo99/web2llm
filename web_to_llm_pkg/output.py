...
def save_outputs(output_base: str, markdown_content: str, context_data: dict):
    ...
    This function creates a directory structure at 'output/<output_base>/' and
    writes the main markdown content and the JSON context file inside it.
    ...
    try:
        ...
        print(f"Successfully created core content file: {md_filename}")
        ...
        print(f"Error: Could not write files. {e}", file=sys.stderr)
