"""Provides common utility functions, mostly for network requests."""

import sys
import requests

# Use a common browser user-agent to avoid being blocked by some websites.
REQUEST_HEADERS = {
...
def fetch_html(url: str) -> str:
    ...
    try:
        ...
        # Wrap the specific network error in a more user-friendly message.
...
def get_url_content_type(url: str) -> str | None:
    ...
    This helps us quickly identify things like PDFs without downloading the whole file.
    """
    try:
        ...
        # This is not a critical error, so we just warn the user.
